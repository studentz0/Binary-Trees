...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col lg:flex-row text-gray-900 font-sans selection:bg-blue-100 selection:text-blue-900">
      ...
      <main className="flex-1 px-4 py-8 sm:p-6 md:p-12 lg:p-16 max-w-6xl mx-auto space-y-16 sm:space-y-24 lg:space-y-32">
        ...
        <div id="intro" className="space-y-6 pt-4 text-center lg:text-left">
          ...
          <p className="text-lg md:text-2xl text-gray-500 max-w-3xl leading-relaxed font-medium mx-auto lg:mx-0">
        ...
        <Section id="zoo" title="The Zoo of Trees" icon={GitGraph}>
          <div className="mb-8 p-5 sm:p-6 bg-white rounded-2xl sm:rounded-3xl border border-gray-100 shadow-sm">
        ...
        <Section id="expression" title="Expression Trees" icon={Divide}>
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center mb-8">
            <div className="space-y-6">
              ...
              <div className="p-5 sm:p-6 bg-orange-50 rounded-2xl sm:rounded-3xl border border-orange-100 space-y-3">
            ...
            <div className="flex justify-center p-6 sm:p-8 bg-white rounded-2xl sm:rounded-3xl border border-gray-100 shadow-inner">
               <svg viewBox="0 0 200 120" className="w-full max-w-[240px] drop-shadow-xl">
        ...
        <Section id="avl" title="AVL Trees & Balancing" icon={ShieldCheck}>
           <div className="mb-8 p-6 sm:p-8 bg-gradient-to-br from-indigo-600 to-blue-700 rounded-2xl sm:rounded-3xl text-white shadow-2xl shadow-blue-200">
        ...
        <footer className="pt-16 pb-12 text-center text-gray-400 border-t border-gray-100">
          <div className="flex justify-center gap-6 mb-6">
            <Layers className="text-gray-300" />
            <GitGraph className="text-gray-300" />
            <Activity className="text-gray-300" />
          </div>
          <p className="font-bold tracking-widest uppercase text-[10px] sm:text-xs">© 2025 TreeMaster Educational Suite • AI Enhanced Learning</p>
        </footer>
