...
export default function App() {
  ...
  return (
    <div className="min-h-screen w-full bg-gray-50 flex flex-col lg:flex-row text-gray-900 font-sans selection:bg-blue-100 selection:text-blue-900 overflow-x-hidden">
      ...
      <main className="flex-1 w-full min-w-0 px-3 sm:px-10 lg:px-20 py-6 sm:py-16 lg:py-24 max-w-screen-2xl mx-auto space-y-12 sm:space-y-32 lg:space-y-40">
        
        {/* Intro */}
        <div id="intro" className="space-y-4 sm:space-y-10 pt-2 text-center lg:text-left section-target w-full">
          ...
          <h1 className="text-2xl sm:text-5xl lg:text-7xl xl:text-8xl font-black text-gray-900 tracking-tighter leading-tight sm:leading-[1.1] text-balance">
          ...
          <p className="text-sm sm:text-xl lg:text-2xl text-gray-400 max-w-3xl leading-relaxed font-semibold mx-auto lg:mx-0 text-balance">
        ...
        <Section id="zoo" title="Structural Taxonomy" icon={GitGraph}>
          <div className="mb-6 sm:mb-16 p-4 sm:p-10 bg-white rounded-xl sm:rounded-[3rem] border border-gray-100 shadow-xl shadow-gray-100/40">
             <p className="text-gray-500 text-xs sm:text-2xl leading-relaxed font-bold text-balance">
        ...
        <Section id="expression" title="Logic in Trees" icon={Divide}>
          <div className="grid lg:grid-cols-2 gap-8 items-center mb-6">
            <div className="space-y-4 sm:space-y-6">
              <p className="text-sm sm:text-2xl text-gray-500 leading-relaxed font-bold">
              ...
              <div className="p-4 sm:p-10 bg-orange-50/50 rounded-xl sm:rounded-[3.5rem] border border-orange-100 space-y-2">
                 ...
                 <h4 className="font-black text-orange-900 text-sm sm:text-xl">Post-order Evaluation</h4>
        ...
        <Section id="avl" title="Self-Balancing Logic" icon={ShieldCheck}>
           <div className="mb-8 p-6 sm:p-16 bg-gradient-to-br from-indigo-600 to-blue-700 rounded-2xl sm:rounded-[5rem] text-white shadow-2xl relative overflow-hidden">
             <h3 className="text-xl sm:text-6xl font-black mb-2 sm:mb-4 flex items-center gap-2 sm:gap-3">
               <ShieldCheck size={20} className="sm:w-16 sm:h-16 text-emerald-400" /> AVL Height
             </h3>
             <p className="text-indigo-100 text-[10px] sm:text-3xl max-w-4xl font-bold leading-relaxed">
        ...
        <footer className="pt-10 pb-8 text-center text-gray-400 border-t border-gray-100 bg-white/50">
          <p className="font-black tracking-[0.2em] uppercase text-[8px] px-6 leading-loose">
