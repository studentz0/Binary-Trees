...
export const AIQuizSection = () => {
  ...
  const startQuiz = async () => {
    ...
    Return as a JSON array: [{"q": string, "options": string[], "correct": number, "explanation": string}].`;
    ...
    return (
      <Card className="border-t-4 border-t-purple-500">
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <p className="text-gray-500 font-medium">Gemini is tailoring questions to your level.</p>
        </div>
      </Card>
    );
  }
  ...
  if (!questions) {
    return (
      <div className="bg-gradient-to-br from-indigo-600 to-purple-700 rounded-[3rem] p-12 text-white text-center shadow-2xl shadow-indigo-200">
        ...
        <p className="mb-10 text-indigo-100 text-lg font-medium opacity-90 max-w-md mx-auto">Test your knowledge with dynamic questions generated by Gemini AI.</p>
        <button 
          onClick={startQuiz}
